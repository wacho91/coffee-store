    ...
    <div className="container my-36">
        <div className='grid grid-cols-1 sm:grid-cols-3 gap-8 place-items-center'>
            ...
            <div className='col-span-2'>
                <motion.img initial={{opacity: 0, scale: 0.5}} whileInView={{opacity: 1, scale: 1}} transition={{ type: "spring", stiffness: 100, damping: 10, delay: 1 }} src={World} alt="" className='w-full sm:w-[500px] mx-auto'/>
            </div>
        </div>
    </div>
  )
